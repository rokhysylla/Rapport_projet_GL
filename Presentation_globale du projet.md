...
Parmis les classes contenant des valeurs numériques on a par exemple  la classe `gson/src/main/java/com.google.gson/stream/JsonReader` dont les nombres sont encapsulés dans des constantes static final avec des noms explicites donc pas magique